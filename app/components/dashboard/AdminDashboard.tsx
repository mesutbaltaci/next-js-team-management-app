...
const AdminDashboard = ({ users, teams, currentUser }: AdminDashboardProps) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Admn Dashboard</h1>
        <p className="text-slate-300">User and Team Management </p>
      </div>
      <div className="grid grid-cols-2 gap-6">
        {/* uses table with role and team assignment */}
                  ...
                  <tr key={user.id} className="border-b border-slate-700">
                    ...
                    <td className="py-2">
                      <select
                        ...
                        className="bg-slate-900 border border-slate-900 rounded px-2 py-1"
                      >
                        {" "}
                    ...
                    <td className="py-2">
                      {user.teamId && (
                        <button
                          ...
                          disabled={isPending}
                          className="text-red-400 hover:tet-red-300 text-xs"
                        >
                          Remove
                        </button>
                      )}
